        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-white font-weight-bold">Pesan Thrift Tanpa Ribet , Semua di Genggaman Anda!</h1>
                    <hr class="divider" />
                </div>
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5">Sekarang anda dapat membeli pakaian thrift tanpa harus pergi ke toko secara offline </p>
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="text-dark-75 mb-4">
                       Pek Second toko yang menyediakan barang barang thrift branded untuk kebutuhan styling kamu
            ...
            <div class="row gx-4 gx-lg-5 bg-white pb-5 rounded">
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="mt-5">
                        ...
                        <p class="text-muted mb-0">Unib Belakang , Bengkulu</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="mt-5">
                        ...
                        <p class="text-muted mb-0">peksecond@gmail.com</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="mt-5">
                        ...
                        <p class="text-muted mb-0">0897 544 6206</p>
                    </div>
                </div>
            </div>
        </div>
