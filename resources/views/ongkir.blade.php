            ...
            jQuery.ajax({
                ...
                success: function (response) {
                    ...
                    if (response) {
                        ...
                        $('#ongkir').append('<li class="list-group-item">'+response[0].code.toUpperCase()+' : <strong>'+response[0].costs[0].service+'</strong> - Rp. '+response[0].costs[0].cost[0].value+' ('+response[0].costs[0].cost[0].etd+' hari)</li>')
                    }
                }
            });
