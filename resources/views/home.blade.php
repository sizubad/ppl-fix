        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{ url('img/pek/slide1.jpg') }}" class="d-block w-100" alt="carousel-1">
                </div>
                <div class="carousel-item">
                    <img src="{{ url('img/pek/slide2.jpg') }}" class="d-block w-100" alt="carousel-2">
                </div>
            </div>
...
@foreach ($kategoris as $kategori)
    <div class="col-md-2 p-1" >
        <a href="{{ route('home', ['kategori'=>$kategori->id]) }}" style="text-decoration: none;">
            ...
            <img src="{{ url('uploads') }}/{{ $kategori->gambar }}" class="card-img-top" style="object-fit: cover; height: 200px; width: 200px;" alt="barang">
